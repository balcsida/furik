    ...
    <div class="wrap">
        ...
        if ($total_donations) {
            ...
            <div class="card">
                ...
                <p><?php echo sprintf(__('Total Donations: %d', 'furik'), $total_donations); ?></p>
                <p><?php echo sprintf(__('Total Amount: %s HUF', 'furik'), number_format($total_amount, 0, ',', ' ')); ?></p>
                <p><?php echo sprintf(__('Active Recurring Donations: %d', 'furik'), $recurring_count); ?></p>
            </div>
            <?php
        }
        ?>
